...
export const experience: Role[] = [
  ...
  },
  {
    ...
    location: "Dubai, UAE",
    blurb: "UAE organic, vegan, gluten-free, and keto grocery store.",
    highlights: [
      "Designed layouts in Adobe XD, Photoshop, and Illustrator",
      "Built responsive Magento front-end in HTML5, CSS, jQuery, and Bootstrap",
    ],
  },
  {
    company: "Shopinc.com",
    ...
    blurb: "UAE multi-vendor e-commerce marketplace.",
    highlights: [
      "Designed and built the Magento marketplace experience",
      "Responsive front-end with HTML5, CSS, jQuery, and Bootstrap",
    ],
  },
  {
    ...
    blurb: "IT services for primarily US-based healthcare clients.",
    highlights: [
      "UI/UX research and layout design for web and mobile products",
      "Built responsive front-ends and CMS sites (WordPress, Magento)",
    ],
  },
  {
    company: "eWoke Innovative Solutions Pvt. Ltd",
    title: "Sr. Web Designer / Front-End Developer",
    period: "Oct 2013 — Nov 2016",
    location: "Kochi, India",
    blurb: "Digital agency serving US, Middle East, Europe, and UK clients.",
    highlights: [
      "Designed and built responsive websites and e-commerce front-ends",
      "HTML5, CSS, jQuery, Bootstrap, and WordPress builds",
    ],
  },
  {
  ...
  {
    company: "Media Crow",
    title: "Jr. Web Designer / HTML Developer",
...
// Placeholder testimonials — replace with real quotes in /ak-admin.
export const testimonials: Testimonial[] = [
  {
    quote:
      "Akhil pairs sharp design instincts with real engineering ability — he doesn't just hand off screens, he ships them. Our conversion and app ratings both moved after his redesigns.",
    name: "Product Lead",
  ...
  {
    quote:
      "He turned a genuinely complex, data-heavy system into something our team could actually use every day. Rare to find someone who understands both UX depth and business impact.",
  ...
  {
    quote:
      "Fast, collaborative, and detail-obsessed. Akhil built our design system from scratch and it's still the backbone of everything we ship. A true end-to-end product designer.",
    name: "Founder",
    role: "Leadership",
